...
- Экран входа для авторизованных пользователей
- Экран входа для неавторизованных пользователей (появляется из первого окна через нажатие на соответствующую кнопку)
